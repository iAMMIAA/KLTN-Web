...
// Định nghĩa các URL từ biến môi trường
...
function App() {
    ...
    const requestSignUp = async (formSignUp) => {
        try {
            const response = await axios.post(`${API_URL}/signup`, formSignUp);
    ...
    const see_notication = (id) => {
        axios
            ...
            .catch((error) => {
                console.error(
                    "There was an error fetching the notification data!",
                    error,
                );
            });
    ...
    useEffect(() => {
        ...
        if (loggedInStatus === "true") {
            ...
            axios
                .get(`${API_URL}/user/${localStorage.getItem("idUser")}`)
                .then((response) => {
            ...
            axios
                .get(
                    `${API_URL}/notification/${localStorage.getItem("idUser")}`,
                )
                .then((response) => {
        ...
        <div className={`drug_web ${darkMode ? "dark_mode" : ""}`}>
            ...
            {noShowSignUp && (
                <SignUp
                    ...
                    openLogIn={setShowLogInForm}
                />
            )}
            {openSeeNotification && (
                <SeeNotification
                    idCmt={idCmt}
                    data={dataSeeNotification}
                    closeSeeNotification={() => setOpenSeeNotification(false)}
                />
            )}
            <div className="container_web">
                <div
                    className={`layout_left ${isSidebarCollapsed ? "active" : ""}`}
                >
                    <div
                        className={`left_first ${isSidebarCollapsed ? "active" : ""} ${isOpenMenu ? "open_by_bar" : ""}`}
                    >
                        ...
                        <div className="list_menu">
                            <ul>
                                ...
                                <li>
                                    <Link to="/exchange" onClick={openExchange}>
                                        <FontAwesomeIcon
                                ...
                                <li>
                                    <Link to="/detect" onClick={openDetection}>
                                        <FontAwesomeIcon
                                            icon={faCapsules}
                                            className="icon_left"
                                        />
                                ...
                                <li>
                                    <Link to="/lookup" onClick={openLookUp}>
                                        <FontAwesomeIcon
                                            icon={faSearch}
                                            className="icon_left"
                                        />
                    ...
                    <div
                        className={`left_container ${isSidebarCollapsed ? "active" : ""} ${isOpenMenu ? "open_by_bar" : ""}`}
                    >
                        <div className="header_menu">
                            <FontAwesomeIcon
                                className={`icon_bars2 ${isOpenMenu ? "open_by_bar" : ""}`}
                                icon={faBars}
                                onClick={openMenuByBar}
                            />
                        ...
                        <div className="list_menu">
                            <ul>
                                <li
                                    className={`itemMenu ${isOpenHome ? "active" : ""} ${darkMode ? "dark_mode" : ""}`}
                                >
                                    <Link
                                        className="text_left"
                                        to="/"
                                ...
                                <li
                                    className={`itemMenu ${isOpenExchange ? "active" : ""} ${darkMode ? "dark_mode" : ""}`}
                                >
                                    <Link
                                        className="text_left"
                                        to="/exchange"
                                ...
                                <li
                                    className={`itemMenu ${isOpenDetection ? "active" : ""} ${darkMode ? "dark_mode" : ""}`}
                                >
                                    <Link
                                        className="text_left"
                                        to="/detect"
                                ...
                                <li
                                    className={`itemMenu ${isOpenLookUp ? "active" : ""} ${darkMode ? "dark_mode" : ""}`}
                                >
                                    <Link
                                        className="text_left"
                                        to="/lookup"
                                ...
                                <li
                                    className={`itemMenu ${isOpenSetting ? "active" : ""} ${darkMode ? "dark_mode" : ""}`}
                                >
                                    <Link
                                        className="text_left"
                                        to="/setting_profile"
                                ...
                                {admin && (
                                    <div className="admin">
                                        <li
                                            className={`itemMenu ${isOpenWritePaper ? "active" : ""} ${darkMode ? "dark_mode" : ""}`}
                                        >
                                            <Link
                                                className="text_left"
                                                to="/write_paper"
                                        ...
                                        <li
                                            className={`itemMenu ${isOpenWriteInfoDrug ? "active" : ""} ${darkMode ? "dark_mode" : ""}`}
                                        >
                                            <Link
                                                className="text_left"
                                                to="/write_info_drug"
                    ...
                    <div
                        className={`left_icon_move ${isOpenMenu ? "open_by_bar" : ""}`}
                    >
                        {isSidebarCollapsed ? (
                            <FontAwesomeIcon
                                className="left_icon"
                                onClick={openLeftIconMove}
                                icon={faForward}
                            />
                        ) : (
                            <FontAwesomeIcon
                ...
                <div
                    className={`layout_main ${isSidebarCollapsed ? "active" : ""}`}
                >
                    <div className="main_container">
                        <div
                            className={`main_one ${fixPositionScroll ? "fixed_main_one" : ""} ${isSidebarCollapsed ? "active" : ""} ${darkMode ? "dark_mode" : ""}`}
                        >
                            <div className="main_one_container">
                                <div
                                    className={`one_menu ${isOpenMenu ? "open_by_bar" : ""}`}
                                >
                                    <FontAwesomeIcon
                                        className={`icon_bars ${isOpenMenu ? "open_by_bar" : ""}`}
                                        icon={faBars}
                                        onClick={openMenuByBar}
                                    />
                                </div>
                                <div className="one_find"></div>
                                <div className="one_notification">
                                    <div
                                        className={`round_icon_notification ${darkMode ? "dark_mode" : ""}`}
                                        icon={faBell}
                                    ...
                                    >
                                        ...
                                        />
                                        <FontAwesomeIcon
                                            className={`icon_circle ${haveNotif ? "show" : ""}`}
                                            icon={faCircle}
                                        />
                                    </div>
                                    {isLoggedIn && isOpenNotification && (
                                        <div
                                            className={`form_notification ${fixPositionScroll ? "fix_menu" : ""} ${darkMode ? "dark_mode" : ""}`}
                                        >
                                            {listNotif.length == 0 ? (
                                                <div className="notif_one_user">
                                                    ...
                                                    <div className="notifi_infomation">
                                                        <h5
                                                            className={`notif_userName_1 ${darkMode ? "dark_mode" : ""}`}
                                                        >
                                                            No User
                                                        </h5>
                                                        <p
                                                            className={`notif_userName_2 ${darkMode ? "dark_mode" : ""}`}
                                                        >
                                                            Không có thông báo!
                                                        </p>
                                                    </div>
                                                ...
                                                listNotif.map((post) => (
                                                    ...
                                                    >
                                                        ...
                                                        ></img>
                                                        <div className="notifi_infomation">
                                                            <h5 className="notif_userName_1">
                                                                {post.username}
                                                            </h5>
                                                            <p className="notif_userName_2">
                                                                {
                                                                    post.contentComment
                                                                }
                                                            </p>
                                ...
                                {isLoggedIn ? (
                                    <div className="one_username">
                                        <div className="one_username_container">
                                            <div
                                                className={`one_noname ${darkMode ? "dark_mode" : ""}`}
                        ...
                        >
                            {isLoggedIn ? (
                                <Routes>
                                    ...
                                    />
                                    <Route
                                        path="/write_info_drug"
                                        element={<WriteInfoDrug />}
                                    />
                                </Routes>
                            ) : (
                                <Routes>
                        ...
                        <div className="footer_web_site">
                            ...
                            <p>
                                <strong>Made by SUNSIK & IAMMIA</strong>
                            </p>
                        </div>
                    </div>
                </div>
