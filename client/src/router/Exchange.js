...
function Exchange() {
    ...
    const getCommentCount = (exchangeId) => {
        return (
            commentCount?.find((item) => item.exchangeId === exchangeId)
                ?.value || 0
        );
    };
    ...
    return (
        <div className="Exchange">
            ...
            <h6 className={`exchange_title ${darkMode ? "dark_mode" : ""}`}>
                Những bài đăng gần đây:
            </h6>
            <div className={`newfeed ${darkMode ? "dark_mode" : ""}`}>
                {data?.map((post, key) => (
                    <div
                        className={`post ${darkMode ? "dark_mode" : ""}`}
                        key={key}
                    >
                        <div className="post-content">
                            ...
                            <div className="post-summary">
                                ...
                                <div className="comment">
                                    {getCommentCount(post.id)} bình luận
                                </div>
                            </div>
                        </div>
