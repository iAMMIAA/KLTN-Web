    ...
    useEffect(() => {
        axios
            ...
            .then((response) => {
                ...
                axios
                    .get(`${API_URL}/related_post/${tagRelatedPost}`)
                    .then((response) => {
    ...
    return (
        <div className="paper">
            ...
            <div className="main_paper">
                <div
                    className={`container_paper ${darkMode ? "dark_mode" : ""}`}
                >
                    ...
                    <div className="author_article">
                        <p>
                            ...
                            <FontAwesomeIcon icon={faClock} /> {dateUpdatePost}
                        </p>
                    </div>
                    ...
                    >
                        <p>
                            Tags: <span className="tag_article">{tagPost}</span>
                        </p>
                    </div>
                    <div
                        className={`end_article ${darkMode ? "dark_mode" : ""}`}
                    >
                        <p>
                            Đang xem: <strong>{titlePost}</strong>
                        </p>
                    </div>
                </div>
            ...
            <div className="related_article">
                <div
                    className={`related_posts_theme ${darkMode ? "dark_mode" : ""}`}
                >
                ...
                <div className="related_posts">
                    {idRelatedPost.map((post) => (
                        <div
                            className={`related_post ${darkMode ? "dark_mode" : ""}`}
                            key={post.id}
                        >
                            ...
                            <div className="related_post_title">
                                <Link
                                    className={`related_post_link ${darkMode ? "dark_mode" : ""}`}
                                    to={`/paper2/${post.id}`}
                                    id="demo"
                                >
                                    {post.title}
                                ...
                                <div
                                    className={`related_post_author ${darkMode ? "dark_mode" : ""}`}
                                >
                                    <p>
