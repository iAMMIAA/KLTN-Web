...
function LookUp() {
    ...
    useEffect(() => {
        ...
        const handleFixedListResult = () => {
            if (window.scrollY > 285) setFixedResult(true);
    ...
    const handleLookUp = () => {
        ...
        axios
            ...
            .then((Response) => {
                ...
                axios
                    .get(`${API_URL}/related_drug/${tagDrug}`)
                    .then((response) => {
    ...
    return (
        <div className="LookUp">
            <div className="uploadImage">
                ...
                <button className="btn_check" onClick={handleLookUp}>
                    Tra cứu
                </button>
            </div>
            ...
            <div className="result">
                {openLookUp ? (
                    <div className="main_result">
                        <div className="square1">
                            ...
                            <div className="over_drug">
                                <div className="describe_drug">
                                    <p>
                                        <strong>Color: </strong> {colorDrug}
                                    </p>
                                    <p>
                                        <strong>Shape: </strong> {shapeDrug}
                                    </p>
                                    <p>
                                        <strong>Imprint: </strong> {imprintDrug}
                                    </p>
                                    <p></p>
                                    <p>
                                        <em>"{describeDrug}"</em>
                        ...
                        <div className="result_flag"></div>
                        <div
                            className={
                                fixedResult ? "fix_list_result" : "list_result"
                            }
                        >
                            <div className="square3">
                                ...
                                <div className="drugImage">
                                    <img
                                        alt="Drug"
                                        src="https://suckhoedoisong.qltns.mediacdn.vn/324455921873985536/2023/12/28/ceef2be96f71c72f9e60-1703752254941963328669.jpg"
                                    />
