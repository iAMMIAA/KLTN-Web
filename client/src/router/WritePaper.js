...
function WritePaper() {
    ...
    const handleSubmit = (event) => {
        ...
        setError("");
        axios
            .post(`${API_URL}/write-paper`, formPaper)
            .then((response) => {
    ...
    return (
        <div className={`Write-Paper`}>
            ...
            <form className={`form-paper`} onSubmit={handleSubmit}>
                <input
                    className="title-paper"
                    type="text"
                    name="title"
                    value={formPaper.title}
                    placeholder="Chủ đề"
                    onChange={handlePaperChange}
                ></input>
                <input
                    className="author-paper"
                    type="text"
                    name="author"
                    value={formPaper.author}
                ...
                <input
                    className="cite-source-paper"
                    type="text"
                    name="cite_source"
                    value={formPaper.cite_source}
