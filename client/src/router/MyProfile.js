...
function MyProfile() {
    ...
    const sendFormUpdatedProfile = (event) => {
        ...
        axios
            .post(
                `${API_URL}/update_profile/${localStorage.getItem("idUser")}`,
                updateFormProfile,
            )
            .then((Response) => {
                        ...
                        <div className="my_profile_name">
                            ...
                            <div className="main_information">
                                <input
                                    ...
                                    type="text"
                                    name="fullName"
                                    value={updateFormProfile.fullName}
                                    onChange={changeFormProfile}
                                ></input>
                                <input
                                    style={{ color: "black" }}
                                    ...
                                    type="text"
                                    name="school"
                                    value={updateFormProfile.school}
                                    onChange={changeFormProfile}
                                ></input>
                            </div>
                        </div>
                    ...
                    <div className="my_profile_name">
                        ...
                        <div className="main_information">
                            <span style={{ color: "gray" }}>
                                {updateFormProfile.fullName}
                            </span>
                            <span style={{ color: "gray" }}>
                                {updateFormProfile.school}
                            </span>
                        </div>
                    </div>
                    <div className="my_profile_infomation">
