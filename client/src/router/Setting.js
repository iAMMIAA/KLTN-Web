...
function Setting() {
    ...
    const handleConfirmDelete = (event) => {
        ...
        axios
            .delete(`${API_URL}/deleteAccount`, {
                data: { useremail: updateFormProfile.email },
            })
            .then((response) => {
                ...
                <div className="setting-switch">
                    <label className="switch">
                        <input
                            type="checkbox"
                            checked={darkMode}
                            onChange={openDarkMode}
                        />
                        <span className="slider"></span>
                    </label>
                    <span>
                        <FontAwesomeIcon icon={faCircleHalfStroke} /> Giao diện
                    </span>
                </div>
                <div>
                    <button
                    ...
                    >
                        <FontAwesomeIcon icon={faLanguage} /> Chuyển đổi ngôn
                        ngữ
                    </button>
                </div>
                <div>
